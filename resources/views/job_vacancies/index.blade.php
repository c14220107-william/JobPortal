...
@section('content')
    <div class="max-w-3xl mx-auto">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Available Job Vacancies</h1>
        <!-- Filter Section -->
        <div class="flex gap-4 mb-6">
            ...
            <div>
                ...
                <select id="position" class="border border-gray-300 p-2 rounded" onchange="filterJobs()">
                    ...
                    <!-- Anda dapat menambahkan opsi posisi yang ada di perusahaan Anda di sini -->
        ...
        <div id="jobListings">
            @foreach ($jobVacancies as $job)
                <div class="md:hover:shadow-md md:px-6 md:py-8 flex flex-col md:gap-4 md:flex-row md:items-start" 
                data-department="{{ $job->deparment->name ?? 'N/A'}}" 
